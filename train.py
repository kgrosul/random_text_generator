...
def file_train(main_dict, input_file, word_num, lowercase):
    """
    :param main_dict: словарь, содержащий модели
    :param input_file: файл с текстом
    :param word_num: количество слов, на основании которых выбирается следующее
...
if __name__ == '__main__':
    ...
    parser.add_argument("--word-num", type=int, default=1, help="length of a Markov chain")
    args = parser.parse_args()

    train(args.input_dir, args.model, args.word_num, args.lc)
